...
const script = join(root, 'research', 'verify-semantic-functional-ledger.mjs');
...
test('el verificador del ledger funcional contesta en ejecución directa, no revienta', () => {
