...
test('REQ-B04 · El schema de decisión es consistente dentro de un run', () => withFixture({}, (x) => { rewriteDecision(x.d2Path, (v) => { v.schema = 'ia.discovery-decision/2'; }); expectCode(() => verify(x), 'DISCOVERY_SCHEMA_INVALID'); }));
