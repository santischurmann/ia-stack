...
// del resto de los gates: si el guard dejara de fijar el codigo de salida, una prueba de cuerpo
// vacio seguiria en verde y el gate quedaria inerte cuando alguien lo corre a mano.
...
const script = join(root, 'scripts', 'verify-red-vitest.mjs');
...
test('el adaptador de vitest propaga el fallo de uso en ejecucion directa', () => {
