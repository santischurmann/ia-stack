...
evaluado cambia entre esa escritura y el commit, `tree_fingerprint` queda viejo y el validador de la
8.1 lo rechaza mecánicamente — no hace falta acordarse de regenerarlo a mano.
